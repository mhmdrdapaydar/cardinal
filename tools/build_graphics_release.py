...
# rubika.py 13:34 — materials and crafted gear became sellable. The shop's sell
# tab already reads the inventory payload, which carries miniItems and
# craftedItems, so both lists are appended to it. Prices mirror the bot: a half
# for ordinary items, a quarter for materials and crafted gear.
SELL_MODERN = [
    ("sell tab lists materials and crafted gear", 'l.jsx("div",{className:"item-list",children:a.data.items.filter(p=>!p.equipped).length?a.data.items.filter(p=>!p.equipped).map(p=>{var y;return l.jsxs("article",{className:"inventory-row",children:[l.jsx("div",{className:"item-glyph",children:"💰"}),l.jsxs("div",{className:"item-info",children:[l.jsx("h4",{children:p.itemName}),l.jsxs("p",{children:["موجودی: ",k(p.quantity)," · قیمت فروش: ",k(Math.floor(((y=p.priceCoins)!=null?y:100)/2)),"C"]})]}),l.jsx(T,{tone:"gold",onClick:()=>void f("sell-item",{itemId:p.itemId}),children:"فروش یک عدد"})]},p.itemId)}):l.jsx(He,{children:"هیچ آیتم قابل فروشی در کوله\u200cپشتی ندارید."})})', 'l.jsxs("div",{className:"item-list",children:[a.data.items.filter(p=>!p.equipped).length?a.data.items.filter(p=>!p.equipped).map(p=>{var y;return l.jsxs("article",{className:"inventory-row",children:[l.jsx("div",{className:"item-glyph",children:"💰"}),l.jsxs("div",{className:"item-info",children:[l.jsx("h4",{children:p.itemName}),l.jsxs("p",{children:["موجودی: ",k(p.quantity)," · قیمت فروش: ",k(Math.floor(((y=p.priceCoins)!=null?y:100)/2)),"C"]})]}),l.jsx(T,{tone:"gold",onClick:()=>void f("sell-item",{itemId:p.itemId}),children:"فروش یک عدد"})]},p.itemId)}):null,a.data.miniItems.map(p=>l.jsxs("article",{className:"inventory-row",children:[l.jsx("div",{className:"item-glyph",children:"🔩"}),l.jsxs("div",{className:"item-info",children:[l.jsx("h4",{children:p.name}),l.jsxs("p",{children:["موجودی: ",k(p.quantity)," · قیمت فروش: ",k(Math.floor((p.priceCoins??0)/4)),"C"]})]}),l.jsx(T,{tone:"gold",onClick:()=>void f("sell-mini",{miniItemId:p.miniItemId}),children:"فروش یک عدد"})]},"m"+p.miniItemId)),a.data.craftedItems.filter(p=>!p.equipped&&p.isTradeable&&p.priceType==="coins").map(p=>l.jsxs("article",{className:"inventory-row",children:[l.jsx("div",{className:"item-glyph",children:"⚒️"}),l.jsxs("div",{className:"item-info",children:[l.jsx("h4",{children:p.itemName}),l.jsxs("p",{children:["قدرت ",k(p.currentPower)," · قیمت فروش: ",k(Math.floor((p.basePrice??0)/4)),"C"]})]}),l.jsx(T,{tone:"gold",onClick:()=>void f("sell-crafted",{instanceId:p.instanceId}),children:"فروش"})]},"c"+p.instanceId)),!a.data.items.filter(p=>!p.equipped).length&&!a.data.miniItems.length&&!a.data.craftedItems.filter(p=>!p.equipped&&p.isTradeable&&p.priceType==="coins").length?l.jsx(He,{children:"هیچ آیتم قابل فروشی در کوله\u200cپشتی ندارید."}):null]})'),
]

SELL_LEGACY = [
    ("sell tab lists materials and crafted gear", 'ce.jsx("div",{className:"item-list",children:f.data.items.filter(function(e){return!e.equipped}).length?f.data.items.filter(function(e){return!e.equipped}).map(function(e){var n;return ce.jsxs("article",{className:"inventory-row",children:[ce.jsx("div",{className:"item-glyph",children:"💰"}),ce.jsxs("div",{className:"item-info",children:[ce.jsx("h4",{children:e.itemName}),ce.jsxs("p",{children:["موجودی: ",Zd(e.quantity)," · قیمت فروش: ",Zd(Math.floor((null!==(n=e.priceCoins)&&void 0!==n?n:100)/2)),"C"]})]}),ce.jsx(op,{tone:"gold",onClick:function(){x("sell-item",{itemId:e.itemId})},children:"فروش یک عدد"})]},e.itemId)}):ce.jsx(ip,{children:"هیچ آیتم قابل فروشی در کوله\u200cپشتی ندارید."})})', 'ce.jsxs("div",{className:"item-list",children:[f.data.items.filter(function(e){return!e.equipped}).length?f.data.items.filter(function(e){return!e.equipped}).map(function(e){var n;return ce.jsxs("article",{className:"inventory-row",children:[ce.jsx("div",{className:"item-glyph",children:"💰"}),ce.jsxs("div",{className:"item-info",children:[ce.jsx("h4",{children:e.itemName}),ce.jsxs("p",{children:["موجودی: ",Zd(e.quantity)," · قیمت فروش: ",Zd(Math.floor((null!==(n=e.priceCoins)&&void 0!==n?n:100)/2)),"C"]})]}),ce.jsx(op,{tone:"gold",onClick:function(){x("sell-item",{itemId:e.itemId})},children:"فروش یک عدد"})]},e.itemId)}):null,f.data.miniItems.map(function(e){return ce.jsxs("article",{className:"inventory-row",children:[ce.jsx("div",{className:"item-glyph",children:"🔩"}),ce.jsxs("div",{className:"item-info",children:[ce.jsx("h4",{children:e.name}),ce.jsxs("p",{children:["موجودی: ",Zd(e.quantity)," · قیمت فروش: ",Zd(Math.floor((e.priceCoins||0)/4)),"C"]})]}),ce.jsx(op,{tone:"gold",onClick:function(){x("sell-mini",{miniItemId:e.miniItemId})},children:"فروش یک عدد"})]},"m"+e.miniItemId)}),f.data.craftedItems.filter(function(e){return!e.equipped&&e.isTradeable&&"coins"===e.priceType}).map(function(e){return ce.jsxs("article",{className:"inventory-row",children:[ce.jsx("div",{className:"item-glyph",children:"⚒️"}),ce.jsxs("div",{className:"item-info",children:[ce.jsx("h4",{children:e.itemName}),ce.jsxs("p",{children:["قدرت ",Zd(e.currentPower)," · قیمت فروش: ",Zd(Math.floor((e.basePrice||0)/4)),"C"]})]}),ce.jsx(op,{tone:"gold",onClick:function(){x("sell-crafted",{instanceId:e.instanceId})},children:"فروش"})]},"c"+e.instanceId)}),f.data.items.filter(function(e){return!e.equipped}).length||f.data.miniItems.length||f.data.craftedItems.filter(function(e){return!e.equipped&&e.isTradeable&&"coins"===e.priceType}).length?null:ce.jsx(ip,{children:"هیچ آیتم قابل فروشی در کوله\u200cپشتی ندارید."})]})'),
]
...
PATCHES: dict[str, list[tuple[str, str, str]]] = {
    ...
    MAIN: SHARED_UI_PATCHES + PARITY_SHARED + PARITY_MODERN + SELL_MODERN + MODERN_UI_PATCHES,
    MAIN_LEGACY: SHARED_UI_PATCHES + PARITY_SHARED + PARITY_LEGACY + SELL_LEGACY + LEGACY_UI_PATCHES,
